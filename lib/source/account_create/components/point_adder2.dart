import 'package:app/source/account_create/controllers/points_adder_controller2.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:get_storage/get_storage.dart';
import 'package:google_fonts/google_fonts.dart';

class PointsAdder2 extends StatelessWidget {
  final PointAdderController2 controller = Get.put(PointAdderController2());
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          GetBuilder<PointAdderController2>(builder: (_) {
            return Row(
